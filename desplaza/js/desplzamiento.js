...
const botonAd =document.getElementById("fechaI");
...
botonAd.addEventListener("click",function(){
    toyota1.classList.remove("toyota1-oculta");
    toyota1.classList.add("toyota1-visible");
    toyota3.classList.remove("toyota3-visible");
    toyota3.classList.add("toyota3-oculta");
});